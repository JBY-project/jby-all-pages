...
(function(){
  ...
  // `short` is the wording narrow screens use, where the full title wraps.
  var BLOCKS = [
    {kind:'yacht',    title:'Yachts for sale', short:'For sale', more:'./index.html#yachts'},
  ...
  function render(hits){
    ...
    BLOCKS.forEach(function(b){
      ...
      var heading = b.short
        ? '<span class="lbl-full">'+esc(b.title)+'</span>' +
          '<span class="lbl-short">'+esc(b.short)+'</span>'
        : esc(b.title);
      html += '<section class="sr-block"><div class="sr-secline"><h2>'+heading+'</h2>' +
